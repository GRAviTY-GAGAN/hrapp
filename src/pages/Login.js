  ...
  return (
    <div className="login">
      <div className="container">
        <div className="cont1">
          <p onMouseOver={() => {setHighlight(true)}} onMouseOut={() => {setHighlight(false)}}
            style={{ cursor: 'default' }}
            className={`${highlight ? 'log highlight' : 'log'}`}>Log In</p>
        </div>
        <div className="cont2">
          <Form form={form} layout="vertical">
            ...
            <Form.Item>
              ...
              <div className="label password ">
                ...
                <Link to="/"><motion.div style={{ fontSize: '0.8rem'}} whileHover={{scale: 1.1 }}>Forgot password?</motion.div></Link>
              </div>
              <Input
                style={{ marginTop: "0.6rem" }}
                type="password"
